...
public class AmazonStepDefinitions {
    ...
    public void souclarin_java_icerdigini_test_eder() {
    ...
    public void sonuclarin_iphone_icerdigini_test_eder_ve_sayfayi_kapatir() {
    ...
    public void urlInIcerdiginiTestEder(String istenenKelime) {
        ...
        Assert.assertTrue(actaulUrl.contains(istenenKelime));
    }
