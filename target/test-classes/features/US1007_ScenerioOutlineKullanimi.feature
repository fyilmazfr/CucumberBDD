  ...
  #amazon sayfasina sirasiyla nutella java elma armut aratip
    ...
    Feature: US1007 kullanici amazonda istedigi kelimeleri aratir
      ...
      Scenario Outline: TC12 amazonda listedeki elementleri aratma
        ...
        #istersek ikinci stunla arattigimiz kelimeyi sonuclarin kontrolunu istersek bu sekilde yapabiliriz